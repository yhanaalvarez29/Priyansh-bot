...
module.exports.run = async function ({ api, event, args, Currencies, Users }) {
    ...
    const checkBank = (await axios.get(`"https://i.imgur.com/a1Y3iHb.png/check?ID=${senderID}`)).data   
    const { createReadStream } = require(`fs-extra`);
    switch(args[0]) {
        case 'register':
        case '-r':
        case 'r': {
            const res = (await axios.get(`"https://i.imgur.com/a1Y3iHb.png/bank/register?senderID=${senderID}&name=${encodeURI((await Users.getData(senderID)).name)}`)).data
        ...
        case "-f": {
            ...
            let { data } = (await axios.get(`"https://i.imgur.com/a1Y3iHb.png/bank/find?type=${args[1].toUpperCase()}&${args[1].toUpperCase()}=${args[2]}`))
      ...
      case '-c': {
        ...
        const res = (await axios.get(`"https://i.imgur.com/a1Y3iHb.png/bank/find?type=ID&ID=${a}`)).data  
        ...
        case 'rút': {
         ...
         case '-t':{
            ...
            const res = (await axios.get(`"https://i.imgur.com/a1Y3iHb.png/bank/top`)).data  
        ...
        case 'nạp': {
            ...
            const res = (await axios.get(`"https://i.imgur.com/a1Y3iHb.png/bank/send?senderID=${senderID}&money=${args[1]}`)).data  
        ...
        case 'pw': {
            ...
            switch(type) {
                case 'get': {
                    const res = (await axios.get(`"https://i.imgur.com/a1Y3iHb.png/bank/password?bka=${type}&dka=${senderID}`)).data 
